    ...
    <Modal isOpen={isOpen} onClose={handleClose} title={mode === 'create' ? '📝 New Note' : '✏️ Edit Note'}>
      <div className="space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            onClick={handleClose}
            className="px-4 py-2 bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg hover:bg-gray-400 dark:hover:bg-gray-600 transition-colors font-medium"
          >
            Cancel
          </button>
        </div>
